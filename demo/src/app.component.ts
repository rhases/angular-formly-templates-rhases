...
export class MainController {
  userFields = [
    ...
    },
    {
      ...
      templateOptions: {
        label: 'Grupos:',
        options: [{ name: 'Não participo.', value: 'no' }],
    ...
    },
    {
      ...
      templateOptions: {
        ...
        options: [
          { id: 'partner', title: 'Cônjuge' },
          { id: 'son', title: 'Filho' },
          { id: 'father', title: 'Pai' },
          { id: 'mother', title: 'Mãe' },
          { id: 'brotherinlaw', title: 'Cunhado' }
        ],
        valueProp: 'id',
        labelProp: 'title'
      }
    ...
    },
    {
      ...
      templateOptions: {
        ...
        options: [
          {
            name: 'Realizar uma cotação',
            value: 'quotation',
            image: 'https://images.rhases.com.br/quote-tassbike/speed.png'
          },
          {
            name: 'Saber mais sobre o Seguro Ciclista',
            value: 'know-more',
            image: 'https://images.rhases.com.br/quote-tassbike/mtb.png'
          }
        ],
        required: true
      }
